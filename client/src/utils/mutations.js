...
export const ADD_JOB = gql`
  mutation addJob($active: Boolean!, $subject: String!, $grade: String!, $dates: String!, $description: String!) {
    addJob(active: $active, subject: $subject, grade: $grade, dates: $dates, description: $description) {
      _id
      active
      description
      subject
